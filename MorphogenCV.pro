...
win32:LIBS += -LC:/opencv-dynamic-qt-dynamic-build/install/x64/mingw/lib -lopencv_core430.dll -lopencv_imgcodecs430.dll -lopencv_imgproc430.dll -lopencv_highgui430.dll -lopencv_videoio430.dll
